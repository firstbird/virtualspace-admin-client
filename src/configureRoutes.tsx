...
import NewGoodsPage from './components/goods/NewGoodsPage';
import UpdateGoodsPage from './components/goods/UpdateGoodsPage';
...
export default () => (
  <Route component={App}>
    ...
    <Route path='/goods/:goodsId' component={GoodsPage} />
    <Route path='/vets' component={GoodsPage} />
    <Route path='/goods/new' component={NewGoodsPage} />
    <Route path='/goods/update/:goodsId' component={UpdateGoodsPage} />
